...
>
	<Switch.Thumb
		class="pointer-events-none block size-4 shrink-0 rounded-full bg-white transition-transform translate-x-0 radix-state-checked:translate-x-radix-switch-thumb radix-state-unchecked:translate-x-0 radix-state-unchecked:shadow-mini "
	/>
</Switch.Root>
