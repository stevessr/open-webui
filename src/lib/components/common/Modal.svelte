...
{#if show}
	...
	<div
		...
		aria-modal="true"
		role="dialog"
		class="modal fixed top-0 right-0 left-0 bottom-0 bg-black/30 dark:bg-black/60 w-full h-screen max-h-[100dvh] {containerClassName}  flex justify-center z-999 overflow-y-auto overscroll-contain"
	...
	>
		<div
			class="trans m-auto w-full {sizeToWidth(size)} {size !== 'full'
				? 'mx-2'
