...
<div class="trans rounded-lg flex flex-col gap-2">
	<div class="">
		...
		<div class="flex gap-2.5 items-center mb-1">
			...
			<div>
				<Select
					id="models"
					className="dark:bg-gray-900 outline-hidden bg-transparent text-sm font-medium block w-fit pr-10 max-w-full placeholder-gray-400"
