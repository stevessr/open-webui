<script lang="ts">
	...
	const saveCustomStyles = () => {
		try {
			...
			window.dispatchEvent(new CustomEvent('customStylesUpdated', {
	...
	<div class="text-gray-700 dark:text-gray-100">
		...
		<div class="flex flex-col w-full p-5 space-y-4 dark:text-gray-200">
			<div class="text-sm text-gray-600 dark:text-gray-400">
				{$i18n.t('Customize the appearance and functionality of the interface with your own CSS and JavaScript code.')}
			</div>
			...
			<div class="space-y-2">
				<div class="flex items-center gap-2">
					...
					<Tooltip content={$i18n.t('Add custom CSS styles to customize the appearance of the interface')}>
			...
			<details class="text-sm">
				...
				<div class="mt-2 space-y-2 text-xs text-gray-500 dark:text-gray-400">
					<div>
						...
						<code class="block mt-1 p-2 bg-gray-100 dark:bg-gray-800 rounded">
						</code>
					</div>
					<div>
