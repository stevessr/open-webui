			...
			<div class="flex flex-col w-full sm:flex-row sm:justify-center sm:space-x-6">
				...
				>
					...
					<div class="flex items-center justify-between py-3 border-b border-gray-100 dark:border-gray-700">
						...
						<Switch
							id="use-img-bed"
							bind:state={useImgBed}
							on:change={toggleUseImgBed}
						/>
					</div>
					...
					<div class="space-y-4">
						...
						<div>
							<label for="img-bed-auth-code" class="block text-sm font-medium text-gray-900 dark:text-white mb-2">
						...
						<div>
							<label for="img-bed-api-token" class="block text-sm font-medium text-gray-900 dark:text-white mb-2">
						...
						<div>
							<label for="upload-channel" class="block text-sm font-medium text-gray-900 dark:text-white mb-2">
							...
							>
								...
								<option value="cfr2">CF R2</option>
						...
						<div>
							<label for="upload-folder" class="block text-sm font-medium text-gray-900 dark:text-white mb-2">
						...
						<details class="border border-gray-200 dark:border-gray-700 rounded-lg">
							<summary class="px-4 py-3 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg">
							...
							<div class="px-4 pb-4 space-y-4">
								<div class="flex items-center justify-between py-2">
									<div>
										<label for="server-compress" class="text-sm font-medium text-gray-900 dark:text-white">
									...
									<Switch
										id="server-compress"
										bind:state={imgBedConfig.serverCompress}
									/>
								</div>
								...
								<div class="flex items-center justify-between py-2">
									...
									<Switch
										id="auto-retry"
										bind:state={imgBedConfig.autoRetry}
									/>
								</div>

								<div>
									<label for="name-type" class="block text-sm font-medium text-gray-900 dark:text-white mb-2">
										{$i18n.t('File Naming')}
									</label>
									<select
										id="name-type"
										...
										class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent"
									>
										<option value="default">{$i18n.t('Default (prefix_name)')}</option>
										<option value="index">{$i18n.t('Index Only')}</option>
										<option value="origin">{$i18n.t('Original Name')}</option>
										<option value="short">{$i18n.t('Short Link')}</option>
									</select>
								</div>

								<div>
									<label for="return-format" class="block text-sm font-medium text-gray-900 dark:text-white mb-2">
									...
									<select
										...
										class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent"
									>
										<option value="default">{$i18n.t('Default (/file/id)')}</option>
										<option value="full">{$i18n.t('Full URL')}</option>
									</select>
								</div>
							</div>
						</details>
						...
						<div class="flex items-center justify-between py-3 px-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
							<div>
								...
								<span class="ml-2 text-sm" class:text-green-600={serviceStatus} class:text-red-600={!serviceStatus}>
