				...
				{:else if STT_ENGINE === ''}
					<div>
						...
						<div class="flex w-full">
							...
							<button
								class="px-2.5 hover:bg-gray-200 text-gray-800 dark:hover:bg-gray-800 dark:text-gray-100 rounded-lg transition"
								on:click={() => {
						...
						<div class="mt-2 mb-1 text-xs text-gray-400 dark:text-gray-500">
							{$i18n.t(`Neko UI uses faster-whisper internally.`)}
				...
				<div class="mb-2">
					...
					{:else if TTS_ENGINE === 'transformers'}
						<div>
							...
							<div class="mt-2 mb-1 text-xs text-gray-400 dark:text-gray-500">
								{$i18n.t(`Neko UI uses SpeechT5 and CMU Arctic speaker embeddings.`)}
