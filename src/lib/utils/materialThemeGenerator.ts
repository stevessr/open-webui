...
export function applyMaterialTheme(palette: ColorPalette, isDark = false): void {
	const MacaronLightTheme: ColorPalette = {
		primary: '#ffd7e1', // Pink
		primaryVariant: '#f9e4ff', // Purple
		secondary: '#c4ffdd', // Green
		secondaryVariant: '#fff9d1', // Yellow
		background: '#fff9f9', // Creamy Pink
		surface: '#ffe8d1', // Orange
		error: '#B00020',
		onPrimary: '#2E2E2E',
		onSecondary: '#2E2E2E',
		onBackground: '#2E2E2E',
	...
	root.style.setProperty('--md-primary', MacaronLightTheme.primary);
	root.style.setProperty('--md-primary-variant', MacaronLightTheme.primaryVariant);
	root.style.setProperty('--md-secondary', MacaronLightTheme.secondary);
	root.style.setProperty('--md-secondary-variant', MacaronLightTheme.secondaryVariant);
	root.style.setProperty('--md-background', MacaronLightTheme.background);
	root.style.setProperty('--md-surface', MacaronLightTheme.surface);
	root.style.setProperty('--md-error', MacaronLightTheme.error);
	root.style.setProperty('--md-on-primary', MacaronLightTheme.onPrimary);
	root.style.setProperty('--md-on-secondary', MacaronLightTheme.onSecondary);
	root.style.setProperty('--md-on-background', MacaronLightTheme.onBackground);
	root.style.setProperty('--md-on-surface', MacaronLightTheme.onSurface);
	root.style.setProperty('--md-on-error', MacaronLightTheme.onError);
