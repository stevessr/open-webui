...
AIOHTTP_CLIENT_TIMEOUT_STREAMING = os.environ.get(
    "AIOHTTP_CLIENT_TIMEOUT_STREAMING", "300"
)

if AIOHTTP_CLIENT_TIMEOUT_STREAMING == "":
    AIOHTTP_CLIENT_TIMEOUT_STREAMING = None
else:
    try:
        AIOHTTP_CLIENT_TIMEOUT_STREAMING = int(AIOHTTP_CLIENT_TIMEOUT_STREAMING)
    except Exception:
        AIOHTTP_CLIENT_TIMEOUT_STREAMING = 300
